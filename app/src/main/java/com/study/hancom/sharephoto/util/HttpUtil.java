...
public class HttpUtil {
    public static void addDefaultForm(DataOutputStream os, String fieldName, String value) throws IOException {
        os.writeBytes(fieldName + ":" + value + "&");
        os.writeBytes("\r\n");
    }

    public static void addDefaultFormForMultipart(DataOutputStream os, String fieldName, String value, String boundary) throws IOException {
    ...
    public static void addFileFormForMultipart(DataOutputStream os, String fieldName, File file, String boundary) throws IOException {
        os.writeBytes("--" + boundary + "\r\n");
